...
# Policy to allow ECR access for pulling images
resource "aws_iam_role_policy" "ecr_access" {
  name_prefix = "${var.cluster_name}-ecr-"
...
resource "aws_iam_role_policy" "argocd_ecr" {
  name_prefix = "${var.cluster_name}-argocd-ecr-"
...
# Policy for GitHub Actions to push to ECR and deploy to EKS
resource "aws_iam_role_policy" "github_ecr_eks_policy" {
  name   = "GitHubECREKSPolicy"
